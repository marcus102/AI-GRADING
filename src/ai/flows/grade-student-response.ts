...
const gradeStudentResponsePrompt = ai.definePrompt({
  ...
  Evaluate the student response based on the rubric and provide a score (out of 10), detailed feedback, and a justification for the score. The score must be an integer or a float with one decimal place (e.g., 7, 8.5).
